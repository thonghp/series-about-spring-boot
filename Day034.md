...
## 4. Code login với google

**B1 cấu hình google app**
...
**B3 code tiếp tục với google**

- Tại sao không chọn là login with google mà là continue with google vì
  - Nếu bạn đã login google, thì không phải login lần nữa => continue
  - Cần phải đăng nhập google để cấp quyền cho ứng dụng
