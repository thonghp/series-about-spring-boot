...
// để chỉ ra nơi có thể truy cập hình ảnh hiển thị cho client
@Configuration
public class MvcConfig implements WebMvcConfigurer {
    ...
    public void addResourceHandlers(ResourceHandlerRegistry registry) {
        ...
        // E:\ProjectJava\ecommerce-v2\images\user-photos
        String absolutePath = path.toFile().getAbsolutePath();

        /*
         * - /images/user-photos/** tất cả request có url bắt đầu như vậy sẽ
         *   được hiển thị
